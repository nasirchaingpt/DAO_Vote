...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-A3ZQWUTT.js";
import "./chunk-CLRVXCUB.js";
import "./chunk-ANJCMEYS.js";
import "./chunk-TVJF2JEP.js";
import {
  require_fast_safe_stringify
} from "./chunk-JJ4R2GYE.js";
import {
  require_browser
...
import {
  ...
  injected,
  mock
} from "./chunk-AHLQ7RWX.js";
import "./chunk-EDDRWZDP.js";
import {
  import_index
} from "./chunk-V7OMDYO2.js";
import "./chunk-QOXUJPXU.js";
import {
  withRetry,
  withTimeout
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-VT5IOTUR.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-YN62NDRU.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-TC6I637X.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-M445O6ZI.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-FKCVLPUZ.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-NDUYAX4W.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-PURYMWNK.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-3USMRUQS.js");
