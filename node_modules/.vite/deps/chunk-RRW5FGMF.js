...
var ICONS = {
  add: async () => (await import("./add-LBZ7THGJ.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-5UXUVEZV.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-ZLCOENMZ.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-LLCULGL2.js")).appStoreSvg,
  apple: async () => (await import("./apple-JLNDGWO4.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-BJEWDEWA.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-GNEZPTD6.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-VI5AESOO.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-LHIRSMPO.js")).arrowTopSvg,
  bank: async () => (await import("./bank-KHUWRW5G.js")).bankSvg,
  browser: async () => (await import("./browser-JG2LXTCQ.js")).browserSvg,
  card: async () => (await import("./card-YPJRLZRS.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-PZK33GXQ.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-FSPTSNI3.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-NXBJQ5JI.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-VJ4FVXW3.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-THGRUAJL.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-KKBTWW7A.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-THF6HKEF.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-3KPL6GQZ.js")).clockSvg,
  close: async () => (await import("./close-GXBZOFHT.js")).closeSvg,
  compass: async () => (await import("./compass-CQHBONCP.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-C5445ESG.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-ZSC2YBVL.js")).copySvg,
  cursor: async () => (await import("./cursor-OW32RC74.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-5LTEJ6RR.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-YKQ4OCJA.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-VAQWNN5R.js")).disconnectSvg,
  discord: async () => (await import("./discord-TCM72G3U.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-OZQJVA3M.js")).etherscanSvg,
  extension: async () => (await import("./extension-UB6AAWBC.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-KUWDHM4E.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-HMQIBDJS.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-OV3W6LTG.js")).farcasterSvg,
  filters: async () => (await import("./filters-G2YG733K.js")).filtersSvg,
  github: async () => (await import("./github-RRTRYKQE.js")).githubSvg,
  google: async () => (await import("./google-J3C4PFC4.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-BQEKAXIT.js")).helpCircleSvg,
  image: async () => (await import("./image-US7RZN7F.js")).imageSvg,
  id: async () => (await import("./id-6MJH6QXR.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-WUOW2GGL.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-TKPN7ZZN.js")).lightbulbSvg,
  mail: async () => (await import("./mail-AKHQNAGW.js")).mailSvg,
  mobile: async () => (await import("./mobile-7TT74D7F.js")).mobileSvg,
  more: async () => (await import("./more-JF45XO3J.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-4MDRTQYH.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-53HG5XS6.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-26WKOL5F.js")).offSvg,
  playStore: async () => (await import("./play-store-XXX65XZZ.js")).playStoreSvg,
  plus: async () => (await import("./plus-CT6WY27B.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-PA5TVKS4.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-AYVBHXB7.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-AC6B5C3G.js")).refreshSvg,
  search: async () => (await import("./search-7TGDBKSS.js")).searchSvg,
  send: async () => (await import("./send-JLOBB3UK.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-SOJREG2P.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-DJCTKWHW.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-6L7DR2NB.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-ODACQDLY.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-HXXHY32Q.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-V33LW4O6.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-QEBTD2WC.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-HZ5ZUZ2W.js")).twitchSvg,
  twitter: async () => (await import("./x-NG7P6CB4.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-BBIF5CRB.js")).twitterIconSvg,
  verify: async () => (await import("./verify-XPARAD2S.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-RHDFMPUE.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-YETNPA4V.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-IDQHCPKO.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-IDQHCPKO.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-IDQHCPKO.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-J2DMVPHO.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-NXAAPD4R.js")).warningCircleSvg,
  x: async () => (await import("./x-NG7P6CB4.js")).xSvg,
  info: async () => (await import("./info-P4WNKXK2.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-PJDD7J2I.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-NT7HGTI6.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RRW5FGMF.js.map
